...
import { FaLinkedinIn, FaPhoneAlt, FaMapMarkerAlt, FaArrowRight } from "react-icons/fa";
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="flex flex-col gap-5">
            ...
            <Link to="/contact-us" className="inline-flex items-center gap-2 text-primary hover:text-white group w-fit">
          ...
          {/* Contact Info */}
          <div className="flex flex-col gap-5">
            <h3 className="text-xl font-bold border-b border-primary/30 pb-2">Contact Information</h3>
            
            <div className="grid grid-cols-1 gap-4">
              <Link to={`mailto:${clientDetails.email}`} className="flex items-center gap-3 text-gray-300 hover:text-primary transition-all duration-300">
              ...
              <Link to={`tel:${clientDetails.phone}`} className="flex items-center gap-3 text-gray-300 hover:text-primary transition-all duration-300">
                <div className="bg-primary/20 p-2 rounded-full">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-6 border-t border-gray-700">
          ...
          <div className="flex gap-4">
            <Link to="#" className="bg-white/10 p-2 rounded-full hover:bg-primary hover:text-white transition-all duration-300">
