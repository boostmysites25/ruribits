...
export const InquiryForm = () => {
  ...
  return (
    <div data-aos="fade-left" className="flex flex-col items-start gap-3 group">
      ...
      <div className="bg-gradient-to-b from-secondary to-secondary/80 rounded-2xl w-fit p-8 shadow-xl">
        ...
        >
          ...
          <button
            ...
            className="mt-5 bg-accent border border-accent text-white px-6 py-3 rounded-full hover:bg-primary hover:border-primary hover:text-white hover:-translate-y-1 duration-300 transition-all font-medium"
          >
            Send Message
          </button>
        </form>
